...
final class Updater: NSObject, ObservableObject, SPUUpdaterDelegate {
    ...
    enum Outcome: Equatable {
        ...
        var message: String? {
            ...
            case .upToDate:      return "Claud-o-meter Notch is up to date."
            ...
            case .unreachable:
                ...
                return "Couldn't reach the update server. Claud-o-meter Notch will try "
    ...
    var isConfigured: Bool {
        guard let key = Bundle.main.object(forInfoDictionaryKey: "SUPublicEDKey") as? String,
              let decoded = Data(base64Encoded: key) else { return false }
    ...
    var lastChecked: Date? { isConfigured ? controller.updater.lastUpdateCheckDate : nil }
    ...
    func start() { if isConfigured { _ = controller } }
