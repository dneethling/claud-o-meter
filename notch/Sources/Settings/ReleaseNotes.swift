...
enum ReleaseNotes {
    static let all: [ReleaseNote] = [
        ReleaseNote(version: "0.1.0", headline: "Your meter, at the screen edge.", changes: [
            .init(title: "Compare both editions", detail: "Keep SwiftBar running while you try this independent notch app."),
            .init(title: "Claude Code login", detail: "Reads your existing Keychain login, without browser cookies. Claude Code refreshes the token."),
            .init(title: "Claude and Codex", detail: "Usage rings, reset countdowns and live session activity. Other providers can be enabled in Settings.")
        ]),
        ReleaseNote(
            version: "1.4.0",
            ...
            changes: [
                ...
                ReleaseNote.Change(
                    ...
                    detail: "Each read from the tool already signed in on this Mac. "
                          + "Claud-o-meter Notch never asks for a password."
                ),
                ReleaseNote.Change(
