...
struct SettingsView: View {
    ...
    var body: some View {
        ...
        Form {
            Section("Integrations") {
                ...
                // the page.
                Text("Claud-o-meter Notch never signs in — each reading is borrowed from the "
            ...
            Section("General") {
                Toggle("Open Claud-o-meter Notch at login", isOn: $preferences.launchAtLogin)
                ...
                if updater.isConfigured {
                    ...
                    Text("Updates are checked daily and apply when the app restarts.")
                    ...
                    Text("Local comparison build. Automatic updates are available in signed releases.")
                        .font(.caption).foregroundStyle(.secondary)
                }
                Text("Version \(updater.currentVersion)")
                    .font(.caption).foregroundStyle(.secondary)
                Link("View Claud-o-meter on GitHub", destination:
                    URL(string: "https://github.com/dneethling/claud-o-meter")!)
    ...
    static let setupCopy =
        "Claud-o-meter Notch reads usage from tools already signed in on this Mac — it "
