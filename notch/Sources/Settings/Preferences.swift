...
final class Preferences: ObservableObject {
    ...
    init(defaults: UserDefaults = .standard) {
        ...
        self.disconnectedProviders = Set(defaults.stringArray(forKey: Keys.disconnected) ?? ["cursor", "gemini", "glm"])
    ...
    static func eraseAllData() {
        let bundleID = Bundle.main.bundleIdentifier ?? "com.darren.claudometer.notch"
    ...
    private func applyLaunchAtLogin() {
        do {
            ...
            launchAtLoginProblem = "macOS refused this — try moving Claud-o-meter Notch to /Applications."
